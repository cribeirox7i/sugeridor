...
export default function StoreCarousel({
  ...
  return (
    // `lg:flex-1` no desktop: ocupa todo o espaço que sobra da coluna de
    // filtros (que agora é largura de CONTEÚDO, ver page.tsx), em vez de uma
    // largura fixa em px — cresce sozinho conforme a tela permite, com a
    // borda esquerda colada no fim dos filtros. Rolar horizontalmente
    // dentro dessa largura continua o comportamento pretendido quando as
    // pílulas (cresce a cada loja nova) não cabem todas de uma vez.
    // `min-w-0` é o que deixa o scroller de fato rolar em vez de esticar o
    // flex item além do espaço disponível; `w-full` vale no mobile, onde o
    // flex da barra é coluna.
    <div className="flex w-full min-w-0 flex-col items-end gap-0.5 lg:min-w-0 lg:flex-1">
